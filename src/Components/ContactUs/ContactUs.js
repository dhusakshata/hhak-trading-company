...
//           <p>
//           For inquiries related to HHAK Trading Pvt Ltd's , please use the contact form below or reach out directly using the provided email and contact details.
//           </p>
...
//            <form  action="https://formspree.io/f/mkgrjvva"
//   method="POST">
...
//       >
//         <FaWhatsapp size={24} style={{ marginRight: "8px", color: "#25D366",fontSize:"14px"}} />
...
//     </div>
//  </section>
//  {/* <section className='contact-end'></section> */}
//     </div>
//   );
// };
    ...
    <div className="contact-us-container">
      ...
      <section>
        <div className='contact-details'>
          <div className='left-contact-section'>
            <div className="form-section">
              <form action="https://formspree.io/f/mkgrjvva" method="POST">
                <div className="form-group">
                  <label htmlFor="company">Name of Company *</label>
                  <input type="text" id="company" placeholder="E.g. John" name="company" required />
                </div>
                ...
                <div className="form-group">
                  <label htmlFor="phone">Phone Number *</label>
                  <input type="tel" id="phone" placeholder="E.g. +1 3004005000" name="phone" required />
                </div>

                <div className="form-group">
                  <label htmlFor="message">Message *</label>
                  <textarea id="message" maxLength="180" placeholder="Enter your message..." name="message" required></textarea>
                </div>
          ...
          <div className='right-contact-section'>
            <div className="contact-boxes">
              ...
              <div className="contact-box">
                <div className="box-inner">
                  ...
                  <div className="box-back">
                    <p>Plot No.11A/1,Gat No.120, Village Karodi,Bombay Highway, Tq.Dist. Aurangabad - 431 136</p>
                  </div>
                </div>
              </div>
              ...
              <div className="contact-box">
                <div className="box-inner">
                  ...
                  <div className="box-back wareback">
                    <p style={{color:"black"}}>Plot No.1,Gat No.48, Near Bharat Weight Bridge, Talawade-Chikhali Road,Talwade, Pune - 411 062</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            {/* Maps Section */}
            <div className="maps-section">
              <h2><i>The HHAK at Your Fingertips . . . </i></h2>
              <div className="maps-container">
                {/* Reg. Office Map */}
                {/* <div className="map circle"> 
                  <iframe src="..." title="Register Office Map" ...></iframe>
                </div> */}
                {/* Warehouse Map */}
                <div className="map circle">
                <iframe
