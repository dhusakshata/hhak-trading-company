  ...
  return (
    <div className='About-section'>
        ...
        <div className="about-container">
          ...
          <p><b><i>Alpine Tool Tech</i></b> a division of HHAK Trading Company, specializes in manufacturing high-quality carbide and steel tools for the cold forging industry. With a focus on precision and durability, the company caters to a wide range of industrial needs, delivering reliable solutions for demanding applications.</p>
      </div>
    </div>
  );
};
